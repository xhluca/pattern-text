...
from pattern_text.text.tree import (
...
from pattern_text.text.en.inflect import (
...
from pattern_text.text.en.inflect_quantify import (
    number, numerals, quantify, reflect
)
# Import mood & modality functions.
from pattern_text.text.en.modality import (
    mood, INDICATIVE, IMPERATIVE, CONDITIONAL, SUBJUNCTIVE,
    modality, uncertain, EPISTEMIC,
    negated
)
# Import all submodules.
from pattern_text.text.en import inflect
from pattern_text.text.en import wordnet
from pattern_text.text.en import wordlist
